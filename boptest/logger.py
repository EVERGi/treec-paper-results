...
class BopLogger(GeneralLogger):
    def __init__(self, save_dir, algo_type, common_params, algo_params, tree_titles):
        ...
        self.checkpoint_dir = self.folder_name + "checkpoint/"
    ...
    def create_dir(self):
        ...
        env_name = f"case_{self.common_params['case']}"
    ...
    def save_checkpoint(self, toolbox):
        checkpoint_file = self.checkpoint_dir + "toolbox.pkl"
        file = open(checkpoint_file, "wb")
        pickle.dump(toolbox, file)
        file.close()
